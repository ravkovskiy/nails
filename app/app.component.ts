...
@Component({
    selector: 'my-app',
    directives: [CarouselComponent, PriceComponent, ActionComponent, PortfolioComponent, ReviewsComponent, ContactsComponent, InputUserComponent, FooterComponent, ROUTER_DIRECTIVES],
